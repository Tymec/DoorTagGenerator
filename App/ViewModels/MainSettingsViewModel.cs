...
public partial class MainSettingsViewModel : ViewModelBase {
    ...
    public MainSettingsViewModel(Configuration config) {
        Config = config;
    ...
    private bool CanAddRoomMember(string name) => !string.IsNullOrEmpty(name) && !Config.RoomMembers.Any(x => x.Name == name);
    ...
    private bool CanRemoveRoomMember(string name) => !string.IsNullOrEmpty(name) && Config.RoomMembers.Any(x => x.Name == name);
